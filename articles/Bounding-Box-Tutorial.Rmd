...
library(here)
library(knitr)
i_am('articles/Bounding-Box-Tutorial.Rmd')
...
include_graphics(here("articles/project-screen-capture.PNG"), rel_path = FALSE)
...
include_graphics(here("articles/jobs-screen-capture.PNG"), rel_path = FALSE)
...
include_graphics(here("articles/cvat-screen-capture.PNG"), rel_path = FALSE)
...
include_graphics(here("articles/shortcut-screen-capture.PNG"), rel_path = FALSE)
...
include_graphics(here("articles/export-screen-capture.PNG"), rel_path = FALSE)
...
include_graphics(here("articles/save-screen-capture.PNG"), rel_path = FALSE)
...
Load the required definitions for training the bounding box regression 
